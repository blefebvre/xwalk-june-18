...
function createOptimizedPicture(
  ...
  // Preserve the origin for cross-origin (e.g. migrated) images so the optimization
  // params resolve against the source host instead of the current (local) origin.
